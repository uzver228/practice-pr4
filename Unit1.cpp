...
{
StatusBar1->SimpleText="Всього рядків: " + IntToStr(Memo1->Lines->Count) +
"       Всього символів: "  + IntToStr(Memo1->Text.Length()) ;
}
//---------------------------------------------------------------------------
...
void __fastcall TForm1::Memo1KeyPress(TObject *Sender, char &Key)
{
  ...
  if(TextMode) {
     ...
     if(Key != 8 && Key != Memo2->Lines->Text.c_str()[it++])
        Label1->Caption = "Помилок: " + IntToStr(++errors);
     if(Key == 8)
        (it > 0) ? it-- : 0;
  }
}
...
void __fastcall TForm1::Button1Click(TObject *Sender)
{
    ...
    Label2->Caption = "Швидкість вводу: " +
                      FloatToStrF(it/(float)in_time*60, ffGeneral, 6, 2) + " символів/хв";
    Label2->Visible = true;
}
//---------------------------------------------------------------------------
...
{
    in_time++;
    Label3->Caption = "Час: " + IntToStr(in_time) + " cек.";
}
//---------------------------------------------------------------------------
